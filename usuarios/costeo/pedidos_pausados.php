...
<html lang="es">
    <head>
        ...
        <title>Costeo | Pedidos Pausados</title>
    <head>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center mt-3">
                        <h1 style="font-family: 'Times New Roman'">Cotizaciones en Espera</h1><br>
                    </div>
                    <!-- DataTable -->
                                    ...
                                    <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center; vertical-align: middle; width: 12%;">Fecha de Realización del Pedido</th>
                                        ...
                                        <tbody>
                                            ...
                                            FROM pedido LEFT JOIN cliente ON pedido.nit = cliente.nit LEFT JOIN entrega ON pedido.id_entrega = entrega.id_entrega WHERE pedido.estado = 'Pausado' ORDER BY pedido.fecha_pedido DESC";
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center align-middle">
                                                        <div>
                                                            <a class="btn btn-info btn-block mb-2" href="mostrar_pedidos_pausados.php?id_pedido=<?php echo $fila['id_pedido']; ?>&nit=<?php echo $fila['nit']; ?>&recibido=0">
                                                            ...
                                                            <button type="button" class="btn btn-warning btn-block mb-2" data-bs-toggle="modal" data-bs-target="#modalPedido<?php echo $fila['id_pedido']; ?>">
                                                                <i class="bi bi-check-lg"></i> Reactivar Pedido
                                                            </button>
                                                        </div>
                                                    </td>
                                                </tr>

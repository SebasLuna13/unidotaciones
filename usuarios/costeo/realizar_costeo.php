<?php
    ...
    if (isset($_POST['submit_editar'])) {
        ...
        $id_deslizador = obtenerValorPost('id_deslizador');
        $precio_deslizador = obtenerValorPost('precio_deslizador');
        ...
        $id_fajon_cintura = obtenerValorPost('id_fajon_cintura');
        ...
        $id_puesta = obtenerValorPost('id_puesta');
        $precio_puesta = obtenerValorPost('precio_puesta');
        ...
        $precio_bolsillo = obtenerValorPost('precio_bolsillo');
        $precio_bolsillocombinado = obtenerValorPost('precio_bolsillocombinado');
        $precio_bolsillocombinado2 = obtenerValorPost('precio_bolsillocombinado2');
        ...
        $valor_deslizador = floatval($precio_deslizador) * floatval($cant_deslizador);
        ...
        $valor_fajon_cintura = floatval($precio_fajon_cintura) * floatval($cant_fajon_cintura);
        ...
        $costo_total =
            floatval($valor_tela) + floatval($valor_telacombi) + floatval($valor_forro) + floatval($precio_bolsa) + floatval($valor_boton) + floatval($valor_boton2) + floatval($valor_broche) + floatval($valor_faya) +
            floatval($valor_cinta) + floatval($valor_cordon) + floatval($valor_cremallera) + floatval($valor_cremallera2) + floatval($valor_deslizador) + floatval($valor_cuello) + floatval($valor_entretela) + floatval($valor_entretela2) +
            ...
            floatval($valor_fajon_cintura) + floatval($precio_bordado) + floatval($precio_estampado) + floatval($valor_flete) + floatval($precio_entrega) + floatval($precio_acabado) + floatval($precio_encarterada) + floatval($precio_puesta) + floatval($valor_diseño) +
            floatval($precio_obra) + floatval($valor_corte) + floatval($precio_logistica) + floatval($precio_bolsillo) + floatval($precio_bolsillocombinado) + floatval($precio_bolsillocombinado2);
        ...
        $consulta = "UPDATE producto SET cant_prendas = '$cant_prendas', mas_prendas = '$mas_prendas', suma_prendas = '$suma_prendas', cant_tallas = '$cant_tallas', id_tela = '$id_tela', precio_tela = '$precio_tela', promedio_consumo = '$promedio_consumo', valor_tela = '$valor_tela',  id_telacombi = '$id_telacombi', precio_telacombinada = '$precio_telacombinada', promedio_telacombi = '$promedio_telacombi',  valor_telacombi = '$valor_telacombi',  id_telaforro = '$id_telaforro', promedio_forro = '$promedio_forro',  precio_forro = '$precio_forro',valor_forro = '$valor_forro', 
                                    ...
                                    precio_obra = '$precio_obra', id_logistica = '1', precio_logistica = '$precio_logistica', precio_bolsillo = '$precio_bolsillo', precio_bolsillocombinado = '$precio_bolsillocombinado', precio_bolsillocombinado2 = '$precio_bolsillocombinado2', id_diseño = '$id_diseño', valor_diseño = '$valor_diseño', id_corte = '$id_corte', id_consumo = '1', valor_corte = '$valor_corte', valor_flete = '$valor_flete', costo_total = '$costo_total', id_encarterada = '$id_encarterada', precio_encarterada = '$precio_encarterada', id_puesta = '$id_puesta', precio_puesta = '$precio_puesta', margen_bruto = '$margen_bruto', precio_venta = '$precio_venta', valor_poliza = '$valor_poliza', valor_porcentajeestampilla = '$valor_porcentajeestampilla', porcentaje_estampilla = '$porcentaje_estampilla', valor_estampilla = '$valor_estampilla', precio_iva = '$precio_iva', precio_total = '$precio_total', observaciones_cotizacion = '$observaciones_cotizacion', observaciones_produccion = '$observaciones_produccion', observaciones_comercial = '$observaciones_comercial'
                                    WHERE id_producto = '$id_producto'";

        $resultado = mysqli_query($enlace, $consulta);
        header("Location: realizar_costeo.php?id_pedido=$id_pedido&id_entrega=$id_entrega&id_usuario=$id_usuario&recibido=1");
        exit();
    }
    ...
    if (isset($_POST['editar_externo'])) {
        ...
        $consulta = "UPDATE producto SET cant_prendas = '$cant_prendas', mas_prendas = '$mas_prendas', suma_prendas = '$suma_prendas', cant_tallas = '$cant_tallas', precio_compra = '$precio_compra', observaciones_cotizacion = '$observaciones_cotizacion', precio_bordado = $precio_bordado, precio_estampado = $precio_estampado, valor_flete = $valor_flete, 
        ...
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: realizar_costeo.php?id_pedido=$id_pedido&id_usuario=$id_usuario&recibido=1");
        exit();
    }
    ...
    if (isset($_POST['cambiar_estado'])) {
        ...
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: inicio_costeo.php?id_usuario=$id_usuario");
        exit();
    }
?>
...
<html>
    <head>
        ...
        <title>Costeo | Costeo de Pedidos</title>
    <head>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg" style="background: linear-gradient(70deg, #020873 0%, #000DD3 100%);">
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <a href="inicio_costeo.php" class="btn active btn-primary">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="card-text mb-1" style="font-family: 'Agency FB', sans-serif; color: black; font-size: 18px;">
                                        ...
                                        <span class="card-title font-weight-bold" style="color: #FF0000; font-family: 'Agency FB', sans-serif; font-size: 20px;">
                                            <?php $precio_formateado = number_format($fila['costo_total']?? 0, 2, ',', '.'); ?>
                                            $ <?= $precio_formateado ?>
                                        </span>
                                    </p>
                                    <p class="card-text mb-1" style="font-family: 'Agency FB', sans-serif; color: black; font-size: 18px;">
                                        ...
                                        <span class="card-title font-weight-bold" style="color: #FF0000; font-family: 'Agency FB', sans-serif; font-size: 20px;">
                                            <?php $precio_formateado = number_format($fila['precio_venta']?? 0, 2, ',', '.'); ?>
                                            $ <?= $precio_formateado ?>
                                        </span>
                                    </p>
                                    <p class="card-text mb-1" style="font-family: 'Agency FB', sans-serif; color: black; font-size: 18px;">
                                        ...
                                        <span class="card-title font-weight-bold" style="color: #FF0000; font-family: 'Agency FB', sans-serif; font-size: 20px;">
                                            <?php $precio_formateado = number_format($fila['precio_iva']?? 0, 2, ',', '.'); ?>
                                            $ <?= $precio_formateado ?>
                                        </span>
                                    </p>
                                    <div class="mb-2 text-center border rounded p-1">
                                        ...
                                        <span class="card-title font-weight-bold" style="color: #FF0000; font-family: 'Agency FB', sans-serif; font-size: 20px;">
                                            <?php $precio_formateado = number_format($fila['precio_total']?? 0, 2, ',', '.'); ?>
                                            $ <?= $precio_formateado ?>
                                        </span>
                                    </div>
                                    ...
                                    <div class="text-center align-middle">
                                        <div class="d-grid gap-2">
                                            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#Editar<?php echo $fila['id_producto']; ?>"
                                                ...
                                                data-id-prendacomprada="<?php echo $fila['id_prendacomprada']; ?>"
        ...
        ?>
            ...
            <div class="modal fade" id="Info<?php echo $fila['id_producto']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                    <div class="modal-content rounded-4">
                        <?php if ($fila['id_tipo_producto'] != 8): ?>
                            <div class="modal-header justify-content-center" style="background: linear-gradient(70deg, #020873 0%, #000DD3 100%);">
                                    ...
                                    <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                        ...
                                        <?php if (!empty($fila['id_tela'])): ?>
                                            <div class="mb-1 mt-1 text-center border rounded p-1">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <p class="card-text" style="color: black;"><span class="font-weight-bold">Consumo:</span> <?= htmlspecialchars($fila['promedio_consumo'] ?? '0') ?> Mts</p>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <p class="card-text" style="color: black;"><span class="font-weight-bold">Precio unitario:</span> $<?= htmlspecialchars($fila['precio_tela'] ?? '0') ?></p>
                                                    </div>
                                                </div>
                                                <div>
                                                    <p class="card-text" style="color: black;"><span class="font-weight-bold">Valor Total Tela:</span> <?= htmlspecialchars($fila['valor_tela'] ?? '0') ?></p>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if (!empty($fila['id_telacombi'])): ?>
                                            <div class="mb-1 mt-1 text-center border rounded p-1">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <p class="card-text" style="color: black;"><span class="font-weight-bold">Consumo:</span> <?= htmlspecialchars($fila['promedio_telacombi'] ?? '0') ?> Mts</p>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <p class="card-text" style="color: black;"><span class="font-weight-bold">Precio unitario:</span> $<?= htmlspecialchars($fila['precio_telacombinada'] ?? '0') ?></p>
                                                    </div>
                                                </div>
                                                <div>
                                                    <p class="card-text" style="color: black;"><span class="font-weight-bold">Valor Tela:</span> <?= htmlspecialchars($fila['valor_telacombi'] ?? '0') ?></p>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <?php if (!empty($fila['id_telaforro'])): ?>
                                            <div class="mb-1 mt-1 text-center border rounded p-1">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <p class="card-text" style="color: black;"><span class="font-weight-bold">Consumo:</span> <?= htmlspecialchars($fila['promedio_forro'] ?? '0') ?> Mts</p>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <p class="card-text" style="color: black;"><span class="font-weight-bold">Precio unitario:</span> $<?= htmlspecialchars($fila['precio_forro'] ?? '0') ?></p>
                                                    </div>
                                                </div>
                                                <div>
                                                    <p class="card-text" style="color: black;"><span class="font-weight-bold">Valor Tela:</span> <?= htmlspecialchars($fila['valor_forro'] ?? '0') ?></p>
                                                </div>
                                            </div>
                                        <?php endif; ?>
        ...
        <script>
            ...
            document.addEventListener("DOMContentLoaded", function() {
                document.querySelectorAll('select[name="id_deslizador"]').forEach(function(select) {
                    ...
                    function actualizarDeslizador(forzarPrecio = false) {
                        ...
                        const form = select.closest("form");
                        const precioInput = form.querySelector('input[name="precio_deslizador"]');
                        const fechaContainer = form.querySelector(".fecha-actualizacion-deslizador-container");
                        const contenedor = form.querySelector("#precioDeslizadorContainer");
                    ...
                    select.addEventListener("change", function() {
                        actualizarDeslizador(true);
                    });

                    // Ejecutar al cargar la página (edición / carga inicial)
                    actualizarDeslizador(false);
                });
            });
            //
            ...
            document.addEventListener("DOMContentLoaded", function() {
                document.querySelectorAll('select[name="id_fajon_cintura"]').forEach(function(select) {
                    ...
                    function actualizarFajonCintura(forzarPrecio = false) {
                        ...
                        const form = select.closest("form");
                        const precioInput = form.querySelector('input[name="precio_fajon_cintura"]');
                        const fechaContainer = form.querySelector(".fecha-actualizacion-fajoncintura-container");
                        const contenedor = form.querySelector("#precioFajonCinturaContainer");
                    ...
                    select.addEventListener("change", function() {
                        actualizarFajonCintura(true);
                    });

                    // Ejecutar al cargar la página
                    actualizarFajonCintura(false);
                });
            });
            //
            ...
            // Script para puesta de cinta
            document.addEventListener('DOMContentLoaded', function() {
                document.querySelectorAll('select[name="id_puesta"]').forEach(function(select) {
                    const precioInput = select.closest('form')?.querySelector('input[name="precio_puesta"]');

                    // Cargar precio inicial si el input está vacío o en 0
                    if (precioInput && (!precioInput.value || parseFloat(precioInput.value) === 0)) {
                        const selectedOption = select.options[select.selectedIndex];
                        const precio_puesta = selectedOption.getAttribute('data-precio_puesta');
                        if (precio_puesta) {
                            precioInput.value = precio_puesta;
                        }
                    }
            ...
            document.addEventListener('change', function(e) {
                if (!e.target.matches('select[name="id_acabado"]')) return;

                const select = e.target;
                const form = select.closest('form');
                const precioInput = form.querySelector('input[name="precio_acabado"]');
                ...
                const precio = select.options[select.selectedIndex].dataset.precio_acabado;
                precioInput.value = precio ?? 0;
            });
            //
            ...
            document.addEventListener('change', function(e) {
                if (!e.target.classList.contains('id_mano_obra')) return;
                ...
                const precio = option.dataset.precio_confeccion;
            ...
            // Script para Corte
            document.addEventListener('change', function(e) {
                if (!e.target.matches('select[name="id_corte"]')) return;

                const select = e.target;
                const form = select.closest('form');
                const precioInput = form.querySelector('input[name="precio_corte"]');
                ...
                const precio = select.options[select.selectedIndex].dataset.precio_corte;
                precioInput.value = precio ?? 0;
            });
            //

...
<html lang="es">
    <head>
        ...
        <title>Costeo | Pedidos Inactivos</title>
    <head>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                <div id="content">
                    ...
                    <div class="text-center mt-3">
                        <h1 style="font-family: 'Times New Roman'">Cotizaciones Inactivas</h1><br>
                    </div>
                    <!-- DataTable -->
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        FROM pedido LEFT JOIN cliente ON pedido.nit = cliente.nit LEFT JOIN entrega ON pedido.id_entrega = entrega.id_entrega WHERE pedido.estado = 'Inactivo' ORDER BY pedido.fecha_pedido DESC";
                                    ...
                                    <div class="modal fade" id="modalEliminar<?php echo $fila['id_pedido']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content rounded-4">
                                                ...
                                                <div class="modal-body">
                                                    <div class="alert alert-warning" role="alert">
                                                        Si continúa, el pedido sera eliminado completamente de la base de datos, una vez eliminado no se podra recuperar.
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <form action="" method="post" id="formulario" enctype="multipart/form-data">

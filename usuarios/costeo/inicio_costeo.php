...
<html lang="es">
    <head>
        ...
        <title>Costeo | Inicio Costeo</title>
    <head>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th style="text-align: center; vertical-align: middle; width: 10%">Solicitud<br>Creada por</th>
                                            ...
                                            <th style="text-align: center; vertical-align: middle; width: 10%;">Fecha entrega <br> Cotizacion</th>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            pedido.estado, pedido.id_entrega, entrega.id_entrega, pedido.id_usuario, entrega.tipo_entrega, pedido.titulo_pedido, pedido.consecutivo, usuario.id_usuario, usuario.encargado
                                            FROM pedido LEFT JOIN cliente ON pedido.nit = cliente.nit LEFT JOIN entrega ON pedido.id_entrega = entrega.id_entrega LEFT JOIN usuario ON pedido.id_usuario = usuario.id_usuario WHERE pedido.estado = 'Espera' ORDER BY pedido.fecha_pedido DESC";
                                        ...
                                        while ($fila = mysqli_fetch_array($resultado)) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    <div>
                                                        <a class="btn btn-info btn-block mb-2" href="realizar_costeo.php?id_pedido=<?php echo $fila['id_pedido']; ?>&nit=<?php echo $fila['nit']; ?>&id_entrega=<?php echo $fila['id_entrega']; ?>&recibido=0">

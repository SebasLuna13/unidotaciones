...
<html lang="es">
    <head>
        ...
        <title>Costeo | Pedidos Finalizados </title>
    <head>
                                        ...
                                        while ($fila = mysqli_fetch_array($resultado)) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    <div>
                                                        <a class="btn btn-info btn-block mb-2" href="mostrar_finalizados_costeo.php?id_pedido=<?php echo $fila['id_pedido']; ?>&nit=<?php echo $fila['nit']; ?>">

...
<html lang="es">
    <head>
        ...
        <title>Costeo | Tipos de Acabado</title>
    <head>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                    <thead>
                                        <tr>
                                            <th style="text-align: center; vertical-align: middle; width: 30%">Tipo de insumo</th>
                                            <th style="text-align: center; vertical-align: middle; width: 30%">Precio</th>
                                            <th style="text-align: center; vertical-align: middle; width: 20%">Fecha Actualizacion</th>
                                    ...
                                    <tbody>
                                        ...
                                        while ($fila = mysqli_fetch_array($resultado)) {
                                            ?>
                                            <tr>
                                                <td class="text-center align-middle"><?php echo $fila['insumo']; ?></td>
                                                ...
                                                <td class="text-center align-middle">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalEditar<?php echo $fila['id_acabado']; ?>">
                                                    ...
                                                    <div class="mb-2 row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="col-sm-2">
                                                                ...
                                                                <input type="number" class="form-control" name="precio" class="form-control" value="<?php echo $value; ?>" pattern="[0-9]+" minlength="1" maxlength="11" style="width: 200px;" required>
                                                            </div>
                                                        </div>
                                                    </div>                                        
                                                    <div class="modal-footer">

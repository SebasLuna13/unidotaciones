<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        $consulta = "INSERT INTO mano_obra (id_mano_obra, producto, precio_confeccion, fecha_actualizacion, id_tipo_prenda) 
                    VALUES ('$id_mano_obra', '$producto', '$precio_confeccion', '$fecha_actualizacion', '$id_tipo_prenda')";

        $resultado = mysqli_query($enlace, $consulta);
        header("Location: mano_obra.php?id_tipo_prenda=$id_tipo_prenda");
        exit();
    }
    ...
    if (isset($_POST['submit_editar'])) {
        ...
        $consulta = "UPDATE mano_obra SET producto = '$producto', precio_confeccion = '$precio_confeccion', fecha_actualizacion = '$fecha_actualizacion' WHERE id_mano_obra = '$id_mano_obra'";
        $resultado = mysqli_query($enlace, $consulta);
        header("Location: mano_obra.php?id_tipo_prenda=$id_tipo_prenda");
        exit();
    }
...
<html lang="es">
    <head>
        ...
        <title>Costeo | Mano de Obra</title>
    <head>
                            ...
                            <d class="row">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                            <div class="modal-content rounded-4">
                                                <div class="modal-header" style="background: linear-gradient(70deg, #020873 0%, #000DD3 100%);">
                                                    <h5 class="modal-title text-white" id="exampleModalLabel">Ingresa los datos a Agregar</h5>
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label" style="color: #000000;">Ingrese tipo de mano de obra:</label>
                                                            <input type="text" class="form-control" name="producto" placeholder="Tipo de mano de obra" minlength="3" maxlength="100" required>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label" style="color: #000000;">Precio de Confección:</label>
                                                            <input type="number" class="form-control" name="precio_confeccion" placeholder="Precio de confección" min="0" max="99999999" required>
                                                        </div>
                                                        <div class="modal-footer">
                                ...
                                <div class="table-responsive">
                                    <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                        <thead>
                                            <tr>
                                                <th style="text-align: center; vertical-align: middle; width: 35%;">Mano de Obra Para:</th>
                                                <th style="text-align: center; vertical-align: middle; width: 15%;">Precio de Confección</th>
                                                <th style="text-align: center; vertical-align: middle; width: 20%;">Fecha de Actualización</th>
                                                <th style="text-align: center; vertical-align: middle;width: 30%">Opciones</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            $consulta = "SELECT mano_obra.id_mano_obra, mano_obra.producto, mano_obra.precio_confeccion, mano_obra.fecha_actualizacion, tipo_prenda.id_tipo_prenda
                                                FROM mano_obra LEFT JOIN tipo_prenda ON mano_obra.id_tipo_prenda = tipo_prenda.id_tipo_prenda
                                                WHERE mano_obra.id_tipo_prenda = $id_tipo_prenda ORDER BY mano_obra.id_mano_obra ASC";
                                            ...
                                            ?>
                                                <tr>
                                                    <td class="text-center align-middle"><?php echo $fila['producto']; ?></td>
                                                    <td class="text-center align-middle"><?php $precio = $fila['precio_confeccion']; $precio_formateado = $precio == intval($precio) ? number_format($precio, 0, ',', '.') : number_format($precio, 2, ',', '.');?>$<?= $precio_formateado ?></td>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            ...
                                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modalEliminar<?php echo $fila['id_mano_obra']; ?>">
                                                                <i class="bi bi-trash-fill"> Eliminar Datos</i>
                                                            </button>
                                                        </div>
                                                    </td>
                                                </tr>
                                ...
                                ?>
                                            ...
                                            <div class="modal-content rounded-4">
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="post" id="formulario" enctype="multipart/form-data">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label" style="color: #000000;">Ingrese tipo de mano de obra:</label>
                                                            <input type="text" class="form-control" name="producto" value="<?php echo $fila['producto']; ?>" pattern="[A-Za-z0-9,\sáéíóúÁÉÍÓÚñÑ]+" minlength="3" maxlength="100" required>
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label" style="color: #000000;">Precio de Confección:</label>
                                                            <input type="number" class="form-control" name="precio_confeccion" value="<?php echo $fila['precio_confeccion']; ?>" placeholder="Precio de confección" min="0" max="99999999" required>
                                                        </div>
                                                        <div class="modal-footer">
                                    ...
                                    <div class="modal fade" id="modalEliminar<?php echo $fila['id_mano_obra']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content rounded-4">
                                                <div class="modal-header text-white rounded-top" style="background: linear-gradient(70deg, #020873 0%, #000DD3 100%);">
                                                    <h5 class="modal-title" id="exampleModalLabel" style="color: white; text-align: center;">¿Realmente desea eliminar este campo: <?php echo $fila['producto']; ?>?</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div class="alert alert-warning" role="alert">
                                                        Si continúa, el campo seleccionado sera eliminada de la base de datos.
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <form action="" method="post" id="formulario" enctype="multipart/form-data">

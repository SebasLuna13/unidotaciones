<?php
    ...
    if (isset($_POST['submit_crear'])) {
        ...
        if (mysqli_num_rows($resultado_verificar_nit) > 0) {
            ...
            $consulta = "INSERT INTO proveedor_tela (nit, nombre, razon_social, celular, repre_comercial, email, banco, tipo_cuenta, num_cuenta, certificado_bancario, autorizacion, departamento, ciudad, direccion, descripcion) 
    ...
    if (isset($_POST['submit_editar'])) {
        $consulta = "UPDATE proveedor_tela SET nombre = '$nombre', razon_social = '$razon_social', celular = '$celular', repre_comercial = '$repre_comercial', email = '$email', banco = '$banco', tipo_cuenta = '$tipo_cuenta', num_cuenta = '$num_cuenta', autorizacion = '$autorizacion', departamento = '$departamento', ciudad = '$ciudad', direccion = '$direccion', descripcion = '$descripcion' 
...
<html lang="es">
    <head>
        ...
        <title>Compras | Proveedores de Telas</title>
    <head>
                            ...
                            <div class="row">
                                ...
                                <div class="table-responsive">
                                    <table id="mytabla" class="table table-striped table-bordered" style="width:100%">
                                        ...
                                        <tbody>
                                            <?php
                                            $consulta = "SELECT proveedor_tela.id_proveedor, proveedor_tela.nit, proveedor_tela.nombre, proveedor_tela.razon_social, proveedor_tela.celular, proveedor_tela.email, proveedor_tela.banco, proveedor_tela.tipo_cuenta, proveedor_tela.num_cuenta, proveedor_tela.certificado_bancario, proveedor_tela.repre_comercial, 
